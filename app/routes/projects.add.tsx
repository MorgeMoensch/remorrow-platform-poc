    ...
    return <>
        ...
        <form>
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div className="sm:col-span-4">
                            ...
                            <div className="mt-2">
                                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <input type="text" name="title" id="title" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Energiesparlampen für Siriks Lifecoaching" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-span-full">
                            ...
                            <p className="mt-3 text-sm leading-6 text-gray-600">Explain what your project is about and your motivation behind it. How does it contribute to a better tomorrow?</p>
                        </div>
                ...
                <div className="border-b border-gray-900/10 pb-12">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">Detailed informations</h2>
                    <p className="mt-1 text-sm leading-6 text-gray-600">To enable filtering by category and to suggest matching partners, we require some more information about your project.</p>

                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                            <label htmlFor="date"
                                   className="block text-sm font-medium leading-6 text-gray-900">Datum</label>
                            <div className="mt-2">
                        ...
                        <div className="sm:col-span-3">
                            <label htmlFor="place"
                                   className="block text-sm font-medium leading-6 text-gray-900">Ort</label>
                            <div className="mt-2">
                        ...
                        <div className="sm:col-span-3">
                            <label htmlFor="compensation"
                                   className="block text-sm font-medium leading-6 text-gray-900">Compensation</label>
                            <div className="mt-2">
                                <input id="compensation" name="compensation" type="text"
                                       className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                            </div>
                        </div>
                        <div className="col-span-full">
                            <label htmlFor="requirements"
                                   className="block text-sm font-medium leading-6 text-gray-900">Requirements</label>
                            <div className="mt-2">
                        ...
                        <div className="col-span-full">
                            ...
                            <div className="text-sm leading-6">
                                <label for="certificate"
                                       className="font-medium text-gray-900">Certificate</label>
                                <p className="text-gray-500">I want my project to be certified by re:morrow (200.-)</p>
                            </div>
                        </div>
                    </div>
                </div>
